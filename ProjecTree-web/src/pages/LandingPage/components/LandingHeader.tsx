        ...
        >
            <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
                ...
                <nav className="hidden md:flex items-center gap-8">
                    <Link to="#features" className="text-sm text-zinc-400 hover:text-emerald-400 transition-colors">
                        기능 소개
                    </Link>
                    <Link to="#pricing" className="text-sm text-zinc-400 hover:text-emerald-400 transition-colors">
                        가격 정책
                    </Link>
                    <Link to="#docs" className="text-sm text-zinc-400 hover:text-emerald-400 transition-colors">
                        문서
                    </Link>
                </nav>
