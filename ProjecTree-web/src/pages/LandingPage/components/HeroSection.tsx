  ...
  return (
    <motion.div
      ...
      style={{
        ...
        bottom: `${startY}%`,
        boxShadow:
          '0 0 6px 2px rgba(52, 211, 153, 0.6), 0 0 12px 4px rgba(52, 211, 153, 0.3)',
      }}
...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        style={{
          x: useTransform(x, (v) => v * 0.015),
          y: useTransform(y, (v) => v * 0.015),
        }}
      ...
      <motion.div
        style={{
          x: useTransform(x, (v) => v * 0.04),
          y: useTransform(y, (v) => v * 0.04),
        }}
        className="absolute top-1/3 left-1/4 h-[600px] w-[600px] rounded-full bg-emerald-600/15 blur-[150px]"
      />
      <motion.div
        style={{
          x: useTransform(x, (v) => -v * 0.03),
          y: useTransform(y, (v) => -v * 0.03),
        }}
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 text-center">
        ...
        >
          ...
          <motion.div
            ...
            style={{
              boxShadow:
                '0 0 30px rgba(16, 185, 129, 0.15), inset 0 1px 0 rgba(255,255,255,0.05)',
            }}
          >
