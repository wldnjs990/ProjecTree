            ...
            <div className="relative mx-auto max-w-6xl px-6 py-12">
                <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                    ...
                    <div className="flex items-center gap-8 text-sm text-zinc-500">
                        <Link to="#" className="hover:text-emerald-400 transition-colors">개인정보처리방침</Link>
                        <Link to="#" className="hover:text-emerald-400 transition-colors">이용약관</Link>
                        <Link to="#" className="hover:text-emerald-400 transition-colors">문의하기</Link>
                    </div>
