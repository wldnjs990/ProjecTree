...
export const ChatPanel = ({ workspaceId, workspaceName }: ChatPanelProps) => {
  ...
  return (
    <div className="flex h-full flex-col bg-white border-t border-gray-200 overflow-hidden">
      {/* 헤더 */}
      <ChatHeader
      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        {/* 참여자 목록 (토글) */}
        {showParticipants && (
          <div className="absolute inset-0 z-30 bg-white border-l border-gray-200 w-full animate-in slide-in-from-right duration-200">
            <ChatParticipantList
