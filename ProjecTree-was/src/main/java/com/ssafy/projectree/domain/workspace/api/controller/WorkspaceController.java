...
public class WorkspaceController implements WorkspaceDocsController {
    ...
    @Override
    public CommonResponse<String> create(@AuthenticationPrincipal Member member, WorkspaceDto.Insert dto, List<MultipartFile> multipartFiles) throws IOException {
