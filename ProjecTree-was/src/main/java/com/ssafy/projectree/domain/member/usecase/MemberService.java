...
public class MemberService {
    ...
    public Member signUp(String email, SignUpDto.Request requestDto) {
        Member member = memberRepository.findByEmail(email).orElseThrow(() -> new BusinessLogicException(ErrorCode.USER_NOT_FOUND_ERROR, "OAuth2 인증이 되지않은 사용자입니다. OAuth2 인증 후 시도해주세요."));
