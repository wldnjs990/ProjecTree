...
요약 관례 : description을 한줄로 요약한 내용. 60자 이내.
### 예시
[
    {
        "name": "[회원 시스템] 소셜 로그인 및 계정 통합 관리",
        "description": "가입 허들을 낮추어 신규 유입을 극대화하기 위해 구글/카카오 소셜 로그인 연동 및 통합 프로필 관리 기능을 구현합니다. 이 에픽은 소셜 로그인 연동, 프로필 관리, 계정 통합 관리 기능을 포함합니다.",
        "summary": "가입 허들을 낮추어 신규 유입을 극대화하기 위해 구글/카카오 소셜 로그인 연동 및 통합 프로필 관리 기능을 구현합니다."
    },
    {
        "name": "[커뮤니티 시스템] 정보 공유 활성화를 위한 마크다운 기반 게시판 시스템",
        "description": "사용자 간의 지식 공유 활성화를 통한 체류 시간 증대를 위해 마크다운 편집기, 실시간 댓글, 좋아요 기능을 포함한 커뮤니티 공간을 구축합니다. 이 에픽은 마크다운 편집기, 실시간 댓글, 좋아요 기능을 포함합니다.",
        "summary": "사용자 간의 지식 공유 활성화를 통한 체류 시간 증대를 위해 마크다운 편집기, 실시간 댓글, 좋아요 기능을 포함한 커뮤니티 공간을 구축합니다."
    }
]
...
[
  {
    "name": "스토리 이름 (예: 사용자는 이메일로 회원가입을 할 수 있다)",
    "description": "이메일 입력, 중복 확인, DB 저장 및 가입 완료 처리",
    "summary": "이메일 회원가입 기능 구현"
  }
]
...
[
  {
    "name": "[Test] 회원가입 서비스 단위 테스트 작성",
    "description": "## 목표\nJUnit을 사용하여 비즈니스 로직의 성공/실패 케이스 검증\n\n## 가이드\nMockMvc나 Mockito를 활용하여 DB 의존성 없이 테스트하는 방법을 학습해보세요.",
    "summary": "회원가입 서비스 단위 테스트 작성"
  }
]
